...
| Third-person model and firearm carry | Public character material shows a connected animated figure and a shouldered firearm with the head/chest readable | Vanguard, Striker, and Phantom are the single playable body family for the local player, all seven bots, and authoritative remotes. Every firearm now owns explicit trigger-hand, support-hand, and reload contact geometry shared by first- and third-person rigs. Rifles use an elbow-down muzzle-low ready stance, pistols use a centered two-hand extension, and launchers sit above the forearm on the shoulder. All 17 firearms pass 272 carry/action poses with 0.0 cm torso penetration and at most 0.6 cm expanded-shoulder contact | PASS | Mechanical modeling/pose contract matches; KYX art remains intentionally original. Three-angle browser captures guard pistol, rifle, shotgun, heavy-weapon, launcher, and energy-weapon silhouettes as well as the numerical rig |
