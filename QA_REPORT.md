...
- Production verification: PASS for all-firearm correction `e39c657` via deployment run `31793165892`; cache-busted `kryx.live` entered a live match and captured both first-person and third-person frames from the deployed runtime.
