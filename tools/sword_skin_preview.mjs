...
try{const page=await browser.newPage({viewport:{width:1500,height:1200}});await page.goto(server.resolvedUrls.local[0]);await page.waitForTimeout(1500);
await page.evaluate(async()=>{
 ...
 const {SWORD_SKINS}=await import('/src/weapons/WeaponSkins.js');const {getWeapon}=await import('/src/weapons/weaponDefs.js');
