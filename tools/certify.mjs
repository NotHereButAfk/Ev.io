...
const AUTO = [
  ...
  { id: 'G-RIFLE-CLEAR', phase: '—', name: 'Complete rifle mesh clears torso and shoulders through actions',
    fn: () => { const r = run('npm run test:rifle-clearance'); return { ok: r.ok && /rifle body clearance passed/.test(r.out), detail: tail(r.out) }; } },
