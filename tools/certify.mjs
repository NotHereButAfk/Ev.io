...
const AUTO = [
  ...
  { id: 'G-AIM', phase: '—', name: 'The gun points where the bullets go',
    fn: () => { const r = run('npm run test:aim'); return { ok: r.ok && /all aim checks passed/.test(r.out), detail: tail(r.out) }; } },
