...
| Third-person model and firearm carry | Public character material shows a connected animated figure and a shouldered firearm with the head/chest readable | Default runtime uses the weighted 11,078-vertex Hero body. All 17 firearms are sampled as complete meshes across 272 attachment/carry/action poses: torso penetration is 0.0 cm, shoulder contact is at most 0.6 cm, trigger-wrist error is at most 0.1 cm, and support-wrist error is 0.0 cm including reload/swap states. Geometry-specific stock/receiver clearance and a 0.55 m firing-shoulder camera preserve readable silhouettes. Legacy Soldiers also pass 48 carry states | PASS | Mechanical modeling/pose contract matches; art style and exact silhouette are intentionally original, not copied |
