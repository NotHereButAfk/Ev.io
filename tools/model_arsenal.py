...
# folding stock: twin bars, hinge blocks, butt plate w/ ribs
g.box((0.024, 0.10, Z+0.005), (0.008, 0.16, 0.010), 'metal', rot=(0, 0, R(4)))
g.box((-0.024, 0.10, Z+0.005), (0.008, 0.16, 0.010), 'metal', rot=(0, 0, R(-4)))
g.box((0.024, 0.03, Z-0.005), (0.012, 0.02, 0.02), 'dark')                   # hinge R
g.box((-0.024, 0.03, Z-0.005), (0.012, 0.02, 0.02), 'dark')                  # hinge L
...
g.row((0.0245, -0.28, Z-0.012), (0, 0.022, 0), 5, (0.002, 0.012, 0.032), 'dark')  # checkering R
g.row((-0.0245, -0.28, Z-0.012), (0, 0.022, 0), 5, (0.002, 0.012, 0.032), 'dark') # checkering L
...
g.box((0, 0.02, Z-0.075), (0.024, 0.11, 0.012), 'metal')
g.box((0, 0.09, Z-0.112), (0.024, 0.012, 0.08), 'metal', rot=(R(16), 0, 0))
g.box((0, -0.038, Z-0.117), (0.024, 0.012, 0.075), 'metal', rot=(R(-14), 0, 0))
g.box((0, 0.026, Z-0.148), (0.024, 0.105, 0.012), 'metal')
g.cyl((0.014, 0.075, Z-0.076), 0.005, 0.028, 'metal', axis='X')              # lever pivot pin
...
def build_ar(blen, hg_len, stock='collapsible', scope=False, carry=False, mag_len=0.10, hg_round=False):
    ...
    # grip + guard + trigger
    a.box((0, 0.10, Z-0.075), (0.04, 0.05, 0.09), 'body', bevel=0.008, rot=(R(20), 0, 0))
...
g.row((0, 0.055, Z+0.046), (0, 0.014, 0), 5, (0.040, 0.005, 0.003), 'dark')  # cover ribs
...
g.box((0, -0.185, Z+0.02), (0.05, 0.13, 0.045), 'body', bevel=0.010)         # upper handguard
...
# banana mag (overlapping sweep) + ribs
...
g.row((-0.038, -0.02, Z+0.02), (0, 0.016, 0), 5, (0.014, 0.007, 0.02), 'metal')
g.row((-0.048, -0.02, Z+0.02), (0, 0.016, 0), 5, (0.006, 0.012, 0.014), 'body')  # brass-ish tips
...
g.row((0.019, -0.45, Z+0.01), (0, 0.012, 0), 3, (0.002, 0.005, 0.014), 'metal')
g.box((0, -0.24, Z+0.052), (0.014, 0.05, 0.035), 'dark', rot=(R(50), 0, 0))  # carry handle post
g.box((0, -0.265, Z+0.075), (0.014, 0.055, 0.012), 'dark')                   # handle grip
# bipod w/ feet
...
g.cyl((0, -0.355, Z-0.005), 0.008, 0.03, 'dark', axis='X')                   # bipod pivot
g.box((0, 0.09, Z-0.075), (0.04, 0.05, 0.085), 'body', bevel=0.008, rot=(R(20), 0, 0))  # grip
g.row((0, 0.118, Z-0.098), (0, 0.006, 0.016), 3, (0.042, 0.004, 0.007), 'dark')
...
g.cyl((0, -0.29, Z+0.01), 0.030, 0.10, 'metal', r2=0.05)                     # warhead taper
g.cyl((0, -0.38, Z+0.01), 0.05, 0.10, 'metal')                               # warhead bulb
g.ring((0, -0.345, Z+0.01), 0.051, 0.003, 'dark')                            # warhead rib 1
g.ring((0, -0.385, Z+0.01), 0.051, 0.003, 'dark')                            # warhead rib 2
g.cone((0, -0.475, Z+0.01), 0.05, 0.10, 'dark')                              # ogive cone
g.cyl((0, -0.53, Z+0.01), 0.006, 0.02, 'metal')                              # fuze tip
g.box((0, -0.10, Z-0.062), (0.036, 0.045, 0.075), 'body', bevel=0.008, rot=(R(14), 0, 0))  # front grip
g.row((0, -0.082, Z-0.092), (0, 0.005, 0.015), 3, (0.038, 0.004, 0.006), 'dark')
g.box((0, 0.03, Z-0.062), (0.036, 0.045, 0.08), 'body', bevel=0.008, rot=(R(18), 0, 0))    # rear grip
g.row((0, 0.05, Z-0.092), (0, 0.005, 0.015), 3, (0.038, 0.004, 0.006), 'dark')
g.box((0, -0.075, Z-0.035), (0.010, 0.012, 0.03), 'metal')                   # trigger
g.box((0, -0.04, Z-0.038), (0.014, 0.03, 0.022), 'dark')                     # trigger housing
...
g.cyl((0.021, 0.225, Z+0.043), 0.005, 0.008, 'metal', axis='X')              # riser knob F
g.cyl((0.021, 0.28, Z+0.043), 0.005, 0.008, 'metal', axis='X')               # riser knob R
g.box((0, 0.33, Z-0.005), (0.05, 0.016, 0.09), 'dark')                       # butt pad
g.row((0, 0.339, Z-0.04), (0, 0, 0.024), 3, (0.044, 0.004, 0.007), 'metal')  # pad ribs
g.box((0, 0.19, Z-0.045), (0.044, 0.05, 0.03), 'dark', bevel=0.004)          # thumbhole bridge
g.box((0, 0.30, Z-0.052), (0.040, 0.06, 0.024), 'body', bevel=0.006)         # toe hook
...
g.row((0.0145, -0.558, Z+0.012), (0, 0.014, 0), 3, (0.002, 0.007, 0.020), 'metal')  # brake ports R
g.row((-0.0145, -0.558, Z+0.012), (0, 0.014, 0), 3, (0.002, 0.007, 0.020), 'metal') # brake ports L
...
g.cyl((0, -0.148, Z+0.075), 0.029, 0.012, 'metal')                           # sunshade lip
g.cyl((0, 0.08, Z+0.075), 0.024, 0.04, 'dark')                               # ocular
g.cyl((0, 0.102, Z+0.075), 0.022, 0.008, 'energy')                           # glowing lens
g.cyl((0, -0.02, Z+0.100), 0.008, 0.016, 'metal', axis='Z')                  # elevation turret
g.cyl((0.026, -0.02, Z+0.075), 0.007, 0.014, 'metal', axis='X')              # windage turret
g.cyl((-0.026, -0.02, Z+0.075), 0.006, 0.010, 'metal', axis='X')             # parallax
g.box((0, -0.055, Z+0.050), (0.014, 0.03, 0.02), 'metal')                    # ring F
g.box((0, 0.045, Z+0.050), (0.014, 0.03, 0.02), 'metal')                     # ring R
g.box((0, 0.045, Z-0.065), (0.034, 0.06, 0.05), 'metal', bevel=0.004, rot=(R(-5), 0, 0))  # mag
g.box((0, 0.045, Z-0.092), (0.037, 0.055, 0.010), 'dark', rot=(R(-5), 0, 0)) # floorplate
...
# ═════════════════════════════════════════════════════════════════════════════
g = Gun(MATS)
g.box((0, -0.01, Z+0.02), (0.052, 0.30, 0.06), 'body', bevel=0.006)          # slab slide
g.box((0, -0.01, Z+0.055), (0.032, 0.28, 0.014), 'dark')                     # top rib
g.row((0, -0.115, Z+0.0625), (0, 0.02, 0), 12, (0.028, 0.008, 0.003), 'body')# rib cuts
...
g.cyl((0, 0.10, Z+0.050), 0.015, 0.026, 'dark', axis='Z')                    # rear drum
g.cyl((0, 0.10, Z+0.068), 0.007, 0.010, 'metal', axis='Z')                   # drum aperture
...
# ═════════════════════════════════════════════════════════════════════════════
g = Gun(MATS)
g.box((0, 0.09, Z-0.01), (0.055, 0.30, 0.10), 'body', bevel=0.020, seg=2)    # rear shell (molded)
g.box((0, -0.10, Z+0.006), (0.052, 0.14, 0.075), 'dark', bevel=0.014, seg=2) # front shell
g.box((0, 0.05, Z-0.055), (0.05, 0.08, 0.03), 'body', bevel=0.012)           # shell belly bridge
g.box((0, 0.0, Z+0.052), (0.044, 0.34, 0.024), 'metal', bevel=0.006)         # top mag body
g.box((0, 0.0, Z+0.068), (0.030, 0.30, 0.010), 'energy', bevel=0.003)        # glowing rounds strip
g.row((0, -0.12, Z+0.068), (0, 0.024, 0), 11, (0.033, 0.004, 0.011), 'dark') # mag ribs over glow
...
g.box((0.014, 0.05, Z+0.082), (0.008, 0.05, 0.008), 'dark')                  # bridge leg R
g.box((-0.014, 0.05, Z+0.082), (0.008, 0.05, 0.008), 'dark')                 # bridge leg L
...
g.row((0, -0.155, Z-0.043), (0, -0.024, 0), 4, (0.052, 0.006, 0.008), 'dark')# pump grooves
...
g.box((0, 0.125, Z-0.052), (0.040, 0.07, 0.05), 'body', bevel=0.012, rot=(R(30), 0, 0))  # wrist
g.row((0.0225, 0.17, Z-0.045), (0, 0.02, -0.005), 4, (0.002, 0.012, 0.026), 'dark', rot=(R(12), 0, 0))  # checkering R
g.row((-0.0225, 0.17, Z-0.045), (0, 0.02, -0.005), 4, (0.002, 0.012, 0.026), 'dark', rot=(R(12), 0, 0)) # checkering L
...
g.box((0, -0.15, Z-0.035), (0.055, 0.22, 0.03), 'body', bevel=0.012)         # wood forend
g.cyl((0.028, -0.20, Z-0.035), 0.004, 0.006, 'metal', axis='X')              # forend screw
...
# big flip-up ladder sight
g.box((0, -0.30, Z+0.048), (0.030, 0.006, 0.012), 'dark')                    # sight base
g.box((0.013, -0.30, Z+0.075), (0.004, 0.004, 0.045), 'metal')               # ladder rail R
...
g.box((0, -0.025, Z+0.034), (0.012, 0.014, 0.014), 'metal', rot=(R(30), 0, 0))   # quillon up
g.box((0, -0.025, Z-0.034), (0.012, 0.014, 0.014), 'metal', rot=(R(-30), 0, 0))  # quillon down
