...
| Third-person model and firearm carry | Public character material shows a connected animated figure and a shouldered firearm with the head/chest readable | Both production body families now use complete-mesh gates. The weighted 11,078-vertex Hero body passes 17 firearms across 272 poses with 0.0 cm torso penetration and at most 0.6 cm shoulder contact. Rigged Soldiers pass the same 17 firearms across 4 armor bodies and 12 states (816 poses) with 0.0 cm torso penetration, at most 0.3 cm conservative shoulder-envelope contact, and 0.00 cm wrist-target error. Slow/failed Soldier loading uses the connected Hero rather than the old procedural mannequin, then hot-upgrades active play when the rig is ready | PASS | Mechanical modeling/pose contract matches; art style and exact silhouette are intentionally original, not copied |
