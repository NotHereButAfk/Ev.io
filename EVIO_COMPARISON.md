...
| Third-person model and firearm carry | Public character material shows a connected animated figure and a shouldered firearm with the head/chest readable | Vanguard, Striker, and Phantom are now the single playable body family for the local player, all seven bots, and authoritative remotes. Saved Soldier ids migrate to the closest exosuit. The exact weighted 11,078-vertex Hero body passes all 17 firearms across 272 carry/action poses with 0.0 cm torso penetration, at most 0.6 cm shoulder contact, and both wrists on their targets | PASS | Mechanical modeling/pose contract matches; KYX art remains intentionally original, and the mixed “human plus attached armor” roster has been retired from normal play |
