...
| Third-person model and firearm carry | Public character material shows a connected animated figure and a shouldered firearm with the head/chest readable | Shinobi, Frost Ronin, and Nightstalker use one connected lightweight shinobi body family for the local player, all seven bots, and authoritative remotes. The silhouette has fitted shoulders/chest, a wrapped dark mask, narrow eye slit, hood knot, and short scarf tails. Every firearm owns explicit trigger-hand, support-hand, and reload contact geometry shared by first- and third-person rigs. Rifles use a reference-driven soldier low-ready: stock retained near the shoulder, firing hand on the grip, support palm under the fore-end, elbows tucked, and muzzle diagonal across the lower chest. Pistols use a centered two-hand extension and launchers sit above the forearm on the shoulder. All 17 firearms pass 272 carry/action poses with 0.0 cm torso penetration and at most 0.6 cm expanded-shoulder contact | PASS | Mechanical modeling/pose contract matches; KYX art remains intentionally original. Front/three-quarter/side/rear browser captures guard the ninja silhouette as well as the numerical rig |
