...
export const WEAPON_HAND_POSES = Object.freeze({
  ...
  uzi:           { trigger: [0.010, -0.060, 0.040], support: [-0.010, 0.020, -0.105], reload: [-0.040, -0.190, 0.020] },
  levershotgun:  { trigger: [0.010, -0.088, 0.140], support: [-0.012, 0.016, -0.255], reload: [-0.040, -0.225, -0.035] },
  m4:            { trigger: [0.012, -0.092, 0.200], support: [-0.012, 0.026, -0.235], reload: [-0.040, -0.260, -0.020] },
  ...
  lmg:           { trigger: [0.012, -0.114, 0.220], support: [-0.012, 0.012, -0.280], reload: [-0.050, -0.265, 0.010] },
  rpg:           { trigger: [0.012, -0.082, 0.060], support: [-0.012, 0.010, -0.255], reload: [-0.045, -0.205, -0.030], carry: 'launcher' },
  boltsniper:    { trigger: [0.012, -0.082, 0.200], support: [-0.012, 0.016, -0.285], reload: [-0.040, -0.245, -0.020] },
  battlerifle:   { trigger: [0.012, -0.090, 0.190], support: [-0.012, 0.020, -0.245], reload: [-0.040, -0.245, -0.020] },
  needler:       { trigger: [0.012, -0.090, 0.145], support: [-0.012, 0.018, -0.185], reload: [-0.045, -0.230, 0.015] },
  plasmarifle:   { trigger: [0.012, -0.086, 0.155], support: [-0.012, 0.018, -0.205], reload: [-0.045, -0.230, 0.005] },
  dmr:           { trigger: [0.012, -0.082, 0.220], support: [-0.012, 0.020, -0.260], reload: [-0.040, -0.245, -0.020] },
  ...
  energyshotgun: { trigger: [0.012, -0.092, 0.175], support: [-0.012, 0.018, -0.245], reload: [-0.040, -0.240, -0.015] },
